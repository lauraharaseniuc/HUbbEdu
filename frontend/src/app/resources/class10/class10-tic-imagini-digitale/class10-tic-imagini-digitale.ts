...
@Component({
  selector: 'app-class10-tic-imagini-digitale',
  imports: [],
  templateUrl: './class10-tic-imagini-digitale.html',
  styleUrl: './class10-tic-imagini-digitale.scss',
})
export class Class10TicImageniDigitale {
